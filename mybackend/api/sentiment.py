...
model_path = "/Users/edbertwidjaja/Downloads/STOCKNAVIGATOR/mybackend/api/sentiment_rnn.pt"
model = torch.jit.load(model_path, map_location=torch.device('cpu'))

# Load the dataset
data = pd.read_csv("/Users/edbertwidjaja/Downloads/STOCKNAVIGATOR/mybackend/api/data.csv")
#print(data.head())
